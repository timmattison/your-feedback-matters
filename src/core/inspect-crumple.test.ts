...
test('openingT: un-crumples from a full wad (t=1) to ~75% flat (INSPECT_CRUMPLE_T)', () => {
...
test('closingT: re-crumples from ~75% flat (INSPECT_CRUMPLE_T) back to a full wad (t=1)', () => {
